...
export function buildSystemPrompt(input: PromptInput): string {
  ...
  const policy = [
    ...
    'Cierre obligatorio: si el cliente dice que no necesita nada más o usa frases finales como "gracias", "muchas gracias", "hasta luego", "buen día", "chau", "corta", "bye" o "thank you", respondé exactamente "Hasta luego." si la llamada está en español, o "Goodbye." si está en inglés, y llamá inmediatamente la herramienta endCall. No sigas conversando ni agregues texto.',
