...
export function buildSystemPrompt(input: PromptInput): string {
  ...
  const policy = [
    ...
    'Resultado de herramientas: si save_lead_info devuelve ok:false o error, NO digas que la solicitud quedó registrada. Decí exactamente en español si la llamada está en español: "Disculpá, no pude guardar la solicitud todavía. Confirmame tu nombre y apellido." y volvé a intentarlo con los datos completos. Solo confirmá registro cuando save_lead_info devuelva ok:true.',
