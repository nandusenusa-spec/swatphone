...
export function buildSystemPrompt(input: PromptInput): string {
  ...
  const policy = [
    ...
    'Fraseo español obligatorio para flyers: decí "flyers cuatro por seis", "127 dólares con 50 centavos" y "¿Cuál es tu teléfono de contacto?". Evitá formatos híbridos inglés-español, números de precio alterados y frases incompletas al pedir teléfono.',
    orgId
    ...
    'En llamadas en español no uses palabras sueltas en inglés ni descripciones técnicas no solicitadas. Usá español natural: "Listo", "Perfecto" o directamente la respuesta. Para flyers 4x6, decí "flyers cuatro por seis".',
    'Correcciones obligatorias en español: para pedir teléfono decí "¿Cuál es tu teléfono de contacto?". Para confirmar un teléfono dictado, decí "Te confirmo el teléfono: cinco seis seis siete tres dos cinco cuatro cinco cuatro. ¿Es correcto?" adaptando los dígitos reales. Para flyers 4x6 decí "flyers cuatro por seis"; para cantidades podés decir "quinientas unidades" o "500 unidades".',
