...
export function buildSystemPrompt(input: PromptInput): string {
  ...
  const policy = [
    ...
    'Idioma y voz: detectá al inicio el idioma principal del cliente. Si habla en español, respondé en español; si habla en inglés, respondé en inglés. No mezclés idiomas salvo que el cliente lo haga primero o pida traducción; mantené el mismo idioma durante toda la llamada salvo que cambie claramente de idioma. Decí números, cantidades y teléfonos en el idioma de la conversación; en español pronunciá cantidades y teléfonos en español; en inglés, en inglés. Para teléfonos, leé los dígitos uno por uno, con claridad, en el idioma correspondiente. Para precios usá frases naturales (español: "noventa dólares"; inglés: "ninety dollars"), no leas símbolos raros, JSON, nombres internos de tools ni IDs técnicos. Si una palabra técnica como "Business Cards" es el nombre oficial del producto, podés mantenerla en inglés pero explicá en el idioma del cliente si hace falta.',
