      ...
      plans: [
        {
          ...
          priceMonthly: 'Free',
          priceYearly: 'Free',
          desc: 'For solo operators testing Luma on a single channel.',
          features: [
        ...
        },
        {
          ...
          priceMonthly: '$49/m',
          priceYearly: '$490/y',
          desc: 'For small teams that need fast response across channels.',
          features: [
        ...
        },
        {
          ...
          priceMonthly: '$149/m',
          priceYearly: '$1,490/y',
          desc: 'For growing companies with high volume across all channels.',
          features: [
            'Unlimited conversations',
            'All channels',
            'Custom voice + script',
            'Team handoffs + analytics',
            'Priority support',
          ],
        },
      ],
      ...
      plans: [
        {
          ...
          priceMonthly: 'Gratis',
          priceYearly: 'Gratis',
          desc: 'Para operadores individuales que prueban Luma en un solo canal.',
          features: [
            'Hasta 50 conversaciones / mes',
            '1 canal (WhatsApp o web)',
            'Respuestas FAQ básicas',
            'Resumen por email',
        ...
        },
        {
          ...
          priceMonthly: '$49/m',
          priceYearly: '$490/a',
          desc: 'Para equipos pequeños que necesitan respuesta rápida en varios canales.',
          features: [
            'Hasta 1.000 conversaciones / mes',
            '3 canales',
            'Integración de calendario',
            'Captura de leads en CRM',
            'Soporte por email',
          ],
        },
        {
          ...
          priceMonthly: '$149/m',
          priceYearly: '$1.490/a',
          desc: 'Para empresas en crecimiento con alto volumen en todos los canales.',
          features: [
            'Conversaciones ilimitadas',
            'Todos los canales',
            'Voz y guion personalizados',
            'Derivación al equipo + analítica',
            'Soporte prioritario',
          ],
        },
      ],
