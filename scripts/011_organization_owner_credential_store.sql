...
--
-- Sin esta tabla, el panel no puede leer ni persistir la contraseña en claro; el email del
-- owner sigue mostrándose desde public.profiles (y Auth) en listado y ficha de cliente.
